"""
Django settings for flowershopproject project.
...
SECRET_KEY = 'django-insecure-kp#1_(c9mr28mbrhjn%s)&#kb=z2s++=^2gb!v1y!)hv#4p_w('
...
ROOT_URLCONF = 'flowershopproject.urls'
...
WSGI_APPLICATION = 'flowershopproject.wsgi.application'
